...
const ShiftGrid = ({ date, shiftNumber, shiftData, nozzles, employees, onSave, readOnly, carryoverData }) => {
  ...
  const canEdit = isSaved && isEditable(shiftData) && !readOnly;
    ...
    <div className="bg-white rounded-lg shadow-card overflow-hidden">
        ...
        <table className="w-full min-w-[1100px]">
          <thead>
            <tr className="bg-adani-navy text-white">
              <th className="px-2 py-3 text-left text-xs font-semibold w-[120px]">Nozzle</th>
              <th className="px-2 py-3 text-left text-xs font-semibold w-[160px]">Employee</th>
              ...
              <th className="px-2 py-3 text-right text-xs font-semibold w-[120px]">Diff (KG)</th>
              ...
              <th className="px-2 py-3 text-right text-xs font-semibold w-[110px]">Cash</th>
            </tr>
          </thead>
          <tbody>
            {rows.map((row, i) => (
      ...
      {notesModalRowIndex !== null && (() => {
        ...
        const expectedCash = selectedRow
          ? parseFloat(((selectedRow.salesRs || 0) - (selectedRow.cc || 0) - (selectedRow.upi || 0)).toFixed(2))
          : 0;
        const notesTotal =
            ...
            <div className="space-y-4">
              ...
              <div className="mt-4 p-3 bg-gray-50 rounded-lg space-y-1.5 text-sm border border-gray-100">
                <div className="flex justify-between text-gray-600">
                  <span>Expected Cash (Sales - CC - UPI):</span>
                  ...
                  <button
                    ...
                    onClick={() => {
                      const updatedRow = {
                        ...
                        coins1: 0,
                        hasNotes: false,
                        cash: Math.max(0, parseFloat(((selectedRow.salesRs || 0) - (selectedRow.cc || 0) - (selectedRow.upi || 0)).toFixed(2))),
                      };
